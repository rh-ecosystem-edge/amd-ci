...
class Settings:
    ...
    gpu_versions_to_test_count: int
    ...
    def __init__(self):
        ...
        self.gpu_versions_to_test_count = int(os.getenv("GPU_VERSIONS_TO_TEST_COUNT", 2))
        ...
        if self.gpu_versions_to_test_count <= 0:
            raise ValueError("GPU_VERSIONS_TO_TEST_COUNT must be a positive integer")
